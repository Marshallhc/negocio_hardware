      ...
      <div className="container mx-auto py-4 flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <a
            ...
            className="inline-flex items-center gap-2 rounded-lg bg-whatsapp px-4 py-2.5 text-sm font-medium text-whatsapp-foreground transition-colors hover:opacity-90"
          >
